...
public class AvroSchemaMessageConverter2 extends MessagingMessageConverter {
    ...
    public AvroSchemaMessageConverter2(AvroMapper avroMapper, SchemaRegistry schemaRegistry) {
    ...
    protected Object extractAndConvertValue(ConsumerRecord<?, ?> record, Type type) {
        System.out.printf("extractAndConvertValue : " + record.value().getClass().getName());
